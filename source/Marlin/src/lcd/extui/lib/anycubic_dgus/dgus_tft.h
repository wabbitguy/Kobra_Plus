...
#define FIRMWARE_VER            "WabbitWare 1.8.2CJ"
#if ENABLED(LIN_ADVANCE)
#define FIRMWARE_VER            "WabbitWare 1.8.2LACJ"
#else
#define FIRMWARE_VER            "WabbitWare 1.8.2CJ"
#endif
#else
#if ENABLED(LIN_ADVANCE)
#define FIRMWARE_VER            "WabbitWare 1.8.2LAJD"
#else
#define FIRMWARE_VER            "WabbitWare 1.8.2JD"
#endif
#endif
